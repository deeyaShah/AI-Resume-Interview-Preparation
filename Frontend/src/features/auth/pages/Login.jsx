...
const Login = () => {
    ...
    return (
        <main className="min-h-screen bg-linear-to-br from-slate-950 via-cyan-950 to-slate-900 flex items-center justify-center px-4">
            ...
            <div className="w-full max-w-md">
                ...
                <div className="bg-white rounded-3xl shadow-2xl p-8 sm:p-10">
                    ...
                    >
                        ...
                        <button
                            type="submit"
                            className="w-full bg-cyan-950 hover:bg-cyan-900 text-white font-semibold py-3.5 rounded-xl transition duration-200 active:scale-[0.98] cursor-pointer"
                        >
                            Login
                        </button>
